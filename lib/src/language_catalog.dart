...
class LanguageCatalog {
  ...
  static Map<String, String> myanamr = {
    "0": "\u1040",
    "1": "\u1041",
    "2": "\u1042",
    "3": "\u1043",
  ...
  static Map<String, String> zawgyi = {
    "0": "\u1040",
    "1": "\u1041",
    "2": "\u1042",
    "3": "\u1043",
  ...
  LanguageCatalog({Language? language}) {
    _language = language ??= Config.instance.language;
  }
  ...
  String _translate(Language language, String key) {
    return switch (language) {
      Language.myanmar => myanamr[key] ?? '',
      Language.english => english[key] ?? '',
      Language.mon => mon[key] ?? '',
      Language.zawgyi => zawgyi[key] ?? '',
    };
  }
}
